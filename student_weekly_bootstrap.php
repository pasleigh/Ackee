...
var g_title;
    ...
    function update_level_list(val)
    {
        ...
        $.ajax({
            type: 'post',
            url: 'fetch_student_weekly_data.php',
            data: {
                'get_level': level_val,
                'get_pm_id': pm_id
            },
            ...
            success: function (data) {
                ...
                for( var i = 0 ; i < mydata.length ; i++ ){
                    ...
                    */
                    ...
                    var my_row_data = [ "<input  value='1' name='" + name + "' " + "id='" + id + "'" + checked + " type='checkbox' />", mydata[i][0], mydata[i][1], mydata[i][2], mydata[i][3], mydata[i][4], mydata[i][5]];
