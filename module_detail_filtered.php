...
// Display the dropdowns to select the module and year
    $display_block .= "<h2><em>Filtered large class</em> data. Overview module plots</h2>";
...
<script type="text/javascript">
    ...
    function update_level_list(val)
    {
        ...
        $.ajax({
            type: 'post',
            url: 'fetch_test.php',
            url: 'fetch_mod_detail_filtered_data.php',
            data: {
                'get_level': level_val,
                'get_pm_id': pm_id
            },
    ...
    function draw_checked_modules(){
        ...
        my_columnplot.title.text = "Filtered large class attendance record for module " + g_iqr_names[i] + " (max number in class: " + g_module_summary_data[i][2] + ")";
