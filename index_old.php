...
// Display the dropdowns to select the module and year
    ...
    if ($POST_OP == "select") {
        ...
        if ($entry_exists) { // exists
            ...
            (@include_once("./year_data.php")) OR die("Cannot find this file to include: year_data.php<BR>");

            //$display_block .= "<p>Editing/viewing of the data for year $year_begin-$year_end_short will go here</p>";
